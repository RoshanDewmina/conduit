...
| **second-opinion-audit** | Independently verifying another AI tool's conversation/report claims (not summarizing) — distrust "done"/"merged" by default; cite `[N] file:line -> claim`; verdicts confirmed/stale/needs-nuance. | — |
