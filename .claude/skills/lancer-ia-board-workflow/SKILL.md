---
name: lancer-ia-board-workflow
description: Use when editing, reviewing, or verifying Lancer IA/design-board work, especially requests to simplify the app, preserve the same design, make prototypes interactive, put new designs at the top of the board, or fix designs that are not visible in the rendered board.
---
...
Use this skill for Lancer board and IA prototype work. The deliverable is visible rendered behavior, not just source edits.
...
- Verify any board/IA claim against `Packages/LancerKit/Sources/AppFeature/AppRoot.swift` + `LancerSidebarView.swift` + `SidebarShellState.swift` — code wins over the prototype/board.
