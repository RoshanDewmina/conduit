---
name: conduit-context-onboarding
description: Use when starting any non-trivial Conduit task in /Users/roshansilva/Documents/command-center, including planning, reviews, implementation, verification, issue triage, reports, or when the user asks an agent to get up to speed from repo context and prior work.
---

# Conduit Context Onboarding

## Overview

Use this skill to build a current, repo-grounded mental model before planning or editing Conduit. Favor current files and verified local state over stale reports or remembered decisions.
...
Load `references/current-conduit-map.md` for the compact map.
...
- Note that there is no root `AGENTS.md` in the Conduit repo unless one is later added; scoped `AGENTS.md` files under subprojects apply only to those scopes.
