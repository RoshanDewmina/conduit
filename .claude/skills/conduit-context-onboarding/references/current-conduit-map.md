...
- App shell and navigation: `Packages/ConduitKit/Sources/AppFeature/`
- Chat transcript and artifacts: `Packages/ConduitKit/Sources/SessionFeature/Chat/`
- Settings: `Packages/ConduitKit/Sources/SettingsFeature/`
- Core protocol types: `Packages/ConduitKit/Sources/ConduitCore/`
- SSH transport: `Packages/ConduitKit/Sources/SSHTransport/`
- Relay bridge/router: `Packages/ConduitKit/Sources/SessionFeature/E2ERelayBridge.swift`, `daemon/conduitd/e2e_router.go`
- Agent dispatch: `daemon/conduitd/dispatch.go`, `daemon/conduitd/server.go`
...
- `docs/CONDUIT_PROJECT_DOSSIER.md` is useful as a broad briefing, but newer June 18 plans may supersede its IA/status details.
