...
private let appGroup = "group.dev.lancer.mobile"
...
struct InboxCountWidgetView: View {
    ...
    private var accessibilityLabel: String {
        entry.pendingCount == 0
            ? "Lancer inbox clear"
            : "Lancer inbox, \(entry.pendingCount) pending approval\(entry.pendingCount == 1 ? "" : "s")"
    }
}
...
struct InboxCountWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Lancer Inbox")
