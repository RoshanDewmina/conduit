...
## Context
Repo `/Users/roshansilva/Documents/command-center`, branch off `feat/warp-style-agent-blocks`. Build: `cd Packages/LancerKit && swift build`. Tests: `swift test`. Read `CLAUDE.md`, `docs/agent-contract.md` §5, `docs/block-terminal-implementation.md`, and `ARCHITECTURE.md`.
