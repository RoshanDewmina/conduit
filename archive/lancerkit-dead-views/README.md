# Archived LancerKit views (dead / old-direction)

Archived **2026-06-12**. These Swift files were moved out of `Packages/LancerKit/Sources/AppFeature/`
...
1. Move the file back into `Packages/LancerKit/Sources/AppFeature/`.
...
4. `cd Packages/LancerKit && swift build`.
