...
public struct AccountConfiguration: Sendable, Equatable {
    ...
    public static func fromBundle(_ bundle: Bundle = .main) -> Self {
        let urlString = bundle.object(forInfoDictionaryKey: "CONDUIT_SUPABASE_URL") as? String
        let key = bundle.object(forInfoDictionaryKey: "CONDUIT_SUPABASE_PUBLISHABLE_KEY") as? String
        return Self(
...
public extension Notification.Name {
    static let conduitAuthCallback = Notification.Name("conduitAuthCallback")
}
...
public actor AccountSessionStore {
    ...
    public init(
        keychain: Keychain = Keychain(service: "dev.conduit.mobile.account"),
        modeStorageKey: String = "dev.conduit.account.mode"
    ) {
...
public final class AccountSessionController {
    ...
    public func requestPasswordReset(email: String) async throws {
        try await client.requestPasswordReset(email: email, redirectURL: URL(string: "conduit://auth/callback")!)
    }
