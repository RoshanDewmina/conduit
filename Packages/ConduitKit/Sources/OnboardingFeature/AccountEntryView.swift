...
public struct AccountEntryView: View {
    ...
    public var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .conduitAuthCallback)) { note in
        ...
        NavigationStack {
            VStack(alignment: .leading, spacing: 16) {
                if passwordResetCallback != nil {
                    ...
                    Text("Use at least 12 characters. This link is consumed only by Conduit.")
                    ...
                    Text("We’ll send a reset link to this email. The app opens conduit://auth/callback to finish securely.")
                        .font(.dsSansPt(14)).foregroundStyle(t.text3).fixedSize(horizontal: false, vertical: true)
                    TextField("you@example.com", text: $email)
                        .textInputAutocapitalization(.never)
                        .textContentType(.emailAddress)
