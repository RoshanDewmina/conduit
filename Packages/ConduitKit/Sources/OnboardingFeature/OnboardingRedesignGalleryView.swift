...
public struct OnboardingRedesignView: View {
    ...
    // Relay pairing: the code is generated by the DESKTOP (`conduitd pair`) and
    ...
    public var body: some View {
        ...
        // Relay pairing: scan the desktop's `conduitd pair` QR, or type its code.
            ...
            OnboardingScanScreen(
                onScan: { payload in
                    ...
                    if let pairing = OnboardingPairing.extractPairing(fromScanned: payload) {
                        ...
                        pairingMessage = "That QR isn't a Conduit pairing code. Run `conduitd pair` on your machine."
                        Haptics.error()
                    }
                },
...
private struct OnboardingPairingBlock: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            // On your desktop, run `conduitd pair` — it prints a QR + 6-digit code.
            Text("ON YOUR DESKTOP, RUN  conduitd pair")
