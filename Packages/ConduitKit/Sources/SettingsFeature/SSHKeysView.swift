        ...
        ZStack(alignment: .top) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    Text("Manage the SSH keypairs Conduit uses to authenticate to your hosts. Private key material never leaves the device keychain — only public keys and fingerprints are shown here.")
                        .font(.dsSansPt(14))
