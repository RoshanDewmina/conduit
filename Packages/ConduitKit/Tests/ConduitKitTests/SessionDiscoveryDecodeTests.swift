...
final class SessionDiscoveryDecodeTests: XCTestCase {
    ...
    func testDecodeSessionDiscovered() {
        let json = #"{"jsonrpc":"2.0","method":"session.discovered","params":{"sessionId":"abc123","tmuxName":"conduit-abc123","agent":"claudeCode","cwd":"/tmp","managed":true}}"#
        ...
        XCTAssertEqual(p.tmuxName, "conduit-abc123")
