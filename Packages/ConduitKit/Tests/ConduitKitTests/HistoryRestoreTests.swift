...
struct HistoryRestoreTests {
    ...
    func prependPutsHistoryFirst() {
        ...
        renderer.prepend(contentsOf: [hist1, hist2])
    ...
    func callerCanDeduplicateByID() {
        ...
        renderer.prepend(contentsOf: [existingBlock])
        #expect(renderer.blocks.count == 1)
        ...
        renderer.prepend(contentsOf: toInsert)
    ...
    func prependedBlocksAreDone() {
        ...
        renderer.prepend(contentsOf: [b1, b2])
