...
struct OpenCodeHookRoundTripTests {
    ...
    /// Wire JSON produced by conduitd `marshalPendingNotification` for an OpenCode
    /// PreToolUse fixture (see daemon/conduitd/testdata/opencode/pretooluse-bash.json).
