...
struct SyncEngineTests {
    ...
    @Test func hostCarriesModifiedAt() {
        let host = LancerCore.Host(name: "Box", hostname: "h", username: "u")
    ...
    @Test func hostWithKeyHint() {
        ...
        let host = LancerCore.Host(name: "Box", hostname: "h", username: "u", syncedKeyHint: hint)
    ...
    @Test func hostRepositoryUpsertSetsModifiedAt() async throws {
        ...
        let now = Date()
        var host = LancerCore.Host(name: "Box", hostname: "h.example.com", username: "user")
    ...
    @Test func hostDeleteCreatesTombstone() async throws {
        ...
        let host = LancerCore.Host(name: "ToDelete", hostname: "x.local", username: "u")
        try await repo.upsert(host)
    ...
    @Test func upsertSyncClearsTombstone() async throws {
        ...
        let repo = HostRepository(db)
        let tombstoneRepo = SyncTombstoneRepository(db)
        let host = LancerCore.Host(name: "Deleted", hostname: "x.local", username: "u")
        try await repo.upsert(host)
