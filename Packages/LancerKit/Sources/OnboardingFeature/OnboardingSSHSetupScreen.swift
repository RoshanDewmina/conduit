...
/// Lancer can open a live terminal on the user's Mac or Linux box. Purely
        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    OnboardingSSHStepRow(
                        number: 3,
                        title: "Add your machine in Lancer",
                        detail: "Tap “Add a machine” below, paste ssh you@your-computer.local, then follow the short key setup inside Lancer."
                    )
                }
                .padding(.horizontal, 24)
                .padding(.top, 28)
