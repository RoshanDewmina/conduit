...
/// stay byte-compatible with `BridgePairingView.QRPairingPayload` and the Go `lancerd pair`
...
public enum OnboardingPairing {
    ...
    /// Extract the pairing code AND the relay URL from a scanned `lancerd pair` QR
    ...
    @MainActor
    public static func stateColor(_ client: E2ERelayClient, tokens t: LancerTokens) -> Color {
        switch client.pairingState {
