...
public final class ProvisioningWizardViewModel {
    ...
    public var provisionedHost: LancerCore.Host?
...
public struct ProvisioningWizard: View {
    ...
    public var onComplete: (LancerCore.Host) -> Void
    public var onCancel: () -> Void
    @Environment(\.lancerTokens) private var t

    public init(hostRepo: HostRepository, onComplete: @escaping (LancerCore.Host) -> Void, onCancel: @escaping () -> Void) {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text("You'll need a Fly.io account and API token. The VM is billed directly by Fly — Lancer never charges you.")
                        .font(.dsSansPt(13))
