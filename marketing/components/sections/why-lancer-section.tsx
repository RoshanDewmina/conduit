...
const PROPS = [
  {
    ...
    body: "Claude's and OpenAI's mobile control each govern only their own agent. Lancer is the one policy, approval, and audit layer across Claude Code, Codex, and opencode.",
  },
  {
  ...
  },
  {
    ...
    body: "Lancer's hook returns a hard deny that holds even under --dangerously-skip-permissions. Default is fail-closed: if the bridge isn't reachable, mutating actions hold rather than auto-run.",
  },
];

export default function WhyLancerSection() {
  return (
    <section id="why-lancer" className="max-w-[1152px] mx-auto px-6 md:px-8 py-20">
      <Reveal>
        <SectionHeader number="06" name="Why Lancer" spectrum />
