...
# release.sh — Build and upload lancerd release binaries to GitHub
#
# Prerequisites:
...
#   GH_REPO     GitHub repo (owner/name). Default: RoshanDewmina/lancer
...
DRY_RUN="${DRY_RUN:-0}"
GH_REPO="${GH_REPO:-RoshanDewmina/lancer}"
...
echo "  dist/ contents:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
(cd "$DIST_DIR" && shasum -a 256 lancerd_*) || true
