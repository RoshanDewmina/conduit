...
**New open item, not yet reconciled with this handoff:** a same-day research pass
(`docs/product/2026-07-05-mobile-native-ai-coding-workflow-research.md`, full package at
`~/Downloads/lancer-proof-to-ship-research-2026-07-05`) proposes a sharper product spine — Needs-Me
Queue as Home, Mission Contract, Decision Capsule/Risk Card, Proof Bundle, Return-to-Desk Packet,
selective Away Mode Live Activity — that goes beyond the ledger-style "Final IA" below. That
research was only read and summarized (by the same Cursor session), not acted on. Whether/how to
realign the wireframed IA to that spine is an open decision for the next design pass, not something
this handoff should be read as already reflecting.
