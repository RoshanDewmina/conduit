...
Prepared: 2026-07-05 · Updated: 2026-07-06
...
> **Away Mode pivot descoped (2026-07-06):** Section 1 "Core Away Mode Loop" uses legacy pivot
> terminology. The checklist items remain valid wireframe targets; see
> `docs/_archive/away-mode-2026-07/README.md`.
...
- **Board section** = where it already lives in `docs/design-audit/lancer-core-wireframes-2026-07-05/index.html`
