...
export const INITIAL_BLOCKS: TerminalBlock[] = [
  {
    ...
    output: [
      " M Packages/ConduitKit/Sources/AppFeature/AppRoot.swift",
      " M Packages/ConduitKit/Sources/InboxFeature/InboxView.swift",
      "?? docs/conduit-ui-prototype/app/interactive/",
    ],
    exit: 0,
    duration: "0.12s",
  },
...
export const FILES: FileEntry[] = [
  ...
  { name: "Conduit", kind: "dir", size: "9 items", touched: "8m" },
...
export const SNIPPETS: Snippet[] = [
  { name: "Run tests", body: "cd Packages/ConduitKit && swift test", scope: "repo" },
  { name: "Restart daemon", body: "sudo systemctl restart conduitd", scope: "host" },
...
export const SETTINGS_GROUPS = [
  ...
  { label: "Bridge", icon: Radio, items: ["conduitd status", "Relay token", "Device registration"] },
]
