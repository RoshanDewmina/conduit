# Conduit UI Prototype — Implementation Plan
...
**Goal:** Build an interactive Next.js web prototype at `docs/conduit-ui-prototype/` showing 3 design variants of the Agent Inbox and 2 variants each of Checkpoint/Ask, Loop Progress, and Report Card — so the user can give feedback on UI direction before any iOS implementation begins.

**Architecture:** Standalone Next.js 15 (App Router) in `docs/conduit-ui-prototype/`. All screens are server components with a `PhoneFrame` wrapper that simulates iOS dimensions (390×844). A top `VariantNav` lets you switch between variants without reloading. All data is mocked in `lib/mock-data.ts`. No backend needed.
...
| File | Responsibility |
|---|---|
| `docs/conduit-ui-prototype/package.json` | Next.js 15 app config |
| `docs/conduit-ui-prototype/app/layout.tsx` | Root layout with Geist font + dark body |
| `docs/conduit-ui-prototype/app/globals.css` | shadcn CSS vars, custom design tokens |
| `docs/conduit-ui-prototype/app/page.tsx` | Variant selector home — visual nav to all screens |
| `docs/conduit-ui-prototype/app/inbox/[variant]/page.tsx` | Inbox variants A, B, C |
| `docs/conduit-ui-prototype/app/checkpoint/[variant]/page.tsx` | Checkpoint variants A, B |
| `docs/conduit-ui-prototype/app/loop/[variant]/page.tsx` | Loop progress variants A, B |
| `docs/conduit-ui-prototype/app/report/[variant]/page.tsx` | Report card variants A, B |
| `docs/conduit-ui-prototype/components/phone-frame.tsx` | CSS iOS phone mockup (390×844) |
| `docs/conduit-ui-prototype/components/variant-nav.tsx` | Top bar with variant switcher |
| `docs/conduit-ui-prototype/components/status-dot.tsx` | Animated status indicator |
| `docs/conduit-ui-prototype/lib/mock-data.ts` | Shared fake inbox/loop/report data |
...
**Files:**
- Create: `docs/conduit-ui-prototype/` (entire Next.js app)

- [ ] **Step 1: Scaffold the Next.js app**

```bash
cd docs
npx create-next-app@latest conduit-ui-prototype \
  --typescript --tailwind --eslint --app \
  --no-src-dir --import-alias "@/*"
cd conduit-ui-prototype
```
...
Replace `docs/conduit-ui-prototype/app/layout.tsx`:
...
Append to `docs/conduit-ui-prototype/app/globals.css`:

```css
:root {
  --conduit-bg: #050810;
  --conduit-surface: rgba(255, 255, 255, 0.03);
  --conduit-border: rgba(255, 255, 255, 0.06);
  --conduit-blue: #3b82f6;
  --conduit-green: #4ade80;
  --conduit-amber: #fbbf24;
  --conduit-red: #f87171;
  --conduit-muted: #6b7280;
  --conduit-mono: var(--font-geist-mono, monospace);
}
...
```bash
git add docs/conduit-ui-prototype
...
**Files:**
- Create: `docs/conduit-ui-prototype/components/phone-frame.tsx`
- Create: `docs/conduit-ui-prototype/components/variant-nav.tsx`
- Create: `docs/conduit-ui-prototype/components/status-dot.tsx`
- Create: `docs/conduit-ui-prototype/lib/mock-data.ts`
...
const statusConfig: Record<Status, { color: string; pulse: boolean }> = {
  decision: { color: "bg-[var(--conduit-red)]", pulse: true },
  blocked: { color: "bg-[var(--conduit-amber)]", pulse: true },
  running: { color: "bg-[var(--conduit-blue)]", pulse: true },
  done: { color: "bg-[var(--conduit-green)]", pulse: false },
  failed: { color: "bg-[var(--conduit-red)]", pulse: false },
...
**Files:**
- Create: `docs/conduit-ui-prototype/app/page.tsx`
- Create: `docs/conduit-ui-prototype/app/inbox/[variant]/layout.tsx` (shared layout with nav)

- [ ] **Step 1: Create shared screen layout**

Create `docs/conduit-ui-prototype/app/inbox/[variant]/layout.tsx`:
...
Replace `docs/conduit-ui-prototype/app/page.tsx`:
...
**Files:**
- Create: `docs/conduit-ui-prototype/app/inbox/a/page.tsx` (Ops Center — dense list)
- Create: `docs/conduit-ui-prototype/app/inbox/b/page.tsx` (Feed — rich cards)
- Create: `docs/conduit-ui-prototype/app/inbox/c/page.tsx` (Dashboard — split pane)

- [ ] **Step 1: Create Inbox Variant A — Ops Center**

Create `docs/conduit-ui-prototype/app/inbox/a/page.tsx`:
...
Create `docs/conduit-ui-prototype/app/inbox/b/page.tsx`:
...
Create `docs/conduit-ui-prototype/app/inbox/c/page.tsx`:
...
> "Here are three inbox design variants for Conduit. Each represents a different information density and layout philosophy:
>
...
**Files:**
- Create: `docs/conduit-ui-prototype/app/checkpoint/a/page.tsx`
- Create: `docs/conduit-ui-prototype/app/checkpoint/b/page.tsx`
...
**Files:**
- Create: `docs/conduit-ui-prototype/app/loop/a/page.tsx`
- Create: `docs/conduit-ui-prototype/app/loop/b/page.tsx`
- Create: `docs/conduit-ui-prototype/app/report/a/page.tsx`
- Create: `docs/conduit-ui-prototype/app/report/b/page.tsx`
...
> "This is the complete UI design for the Conduit iOS app based on all the feedback.
> If this looks good, the next step is Plan 2 (iOS Inbox) — implementing these screens in SwiftUI using the Conduit design system.
