...
3. **App Store Connect assets** (D2): app record, Push + CloudKit + App Groups entitlements,
   IAP `dev.lancer.mobile.pro` Non-Consumable $14.99, privacy nutrition label, screenshots,
   reviewer notes — **including promoting the CloudKit schema from Development to Production**
