...
export const THREADS: ChatThread[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: "m2",
        role: "assistant",
        body: "I found the old prototype still compares Approval, Fleet, and Session modes. I am replacing that with chat-first, attention-first, and fleet-first sidebars while keeping the same dark Lancer design language.",
        time: "9:33",
        status: "complete",
        artifacts: [
