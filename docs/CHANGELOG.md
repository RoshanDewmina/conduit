...
- 15:17 Cursor Grok 4.5 — Settings “Send Feedback” sheet + `FeedbackClient` → `POST /feedback` (LANCER_PUSH_BACKEND_URL / RelaySettings HTTPS base); URLProtocol tests green (`feat/feedback-ios`)
