...
- 09:48 Cursor Grok — RepoPickerView: Add Repo sheet (Workspaces pattern) + select-after-add so composer "Add a repo first" is no longer a dead end (`fix/composer-addrepo-deadend`)
