# Conduit — Manual QA Run (2026-05-30)
...
|---|---|---|
| Onboarding | ✅ PASS | "How Conduit works" BYO card, full-width DS buttons, "Provision a new Fly.io VM · Beta" caption (no dead-end CTA) |
...
> "Add Dynamic Type support to the Conduit iOS app (`Packages/ConduitKit`). READ-ONLY context first:
...
> where growth would break layout. Build after each step (`cd Packages/ConduitKit && swift build`) and
