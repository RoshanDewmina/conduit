...
| chat-device-test-checklist §1–6 | Shipped in sidebar app | Needs live-shell rerun |
| chat-device-test-checklist §7 (APNs lock-screen) | Proven 2026-06-23 | Needs live-shell rerun |
