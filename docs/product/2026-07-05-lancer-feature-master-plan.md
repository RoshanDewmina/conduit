...
Compiled: 2026-07-05 · Updated: 2026-07-06 (Away Mode pivot descoped)
Status: **This is now the single source of truth for Lancer feature scope.** Supersedes the 7
overlapping July-4 product-strategy docs listed in §1 (kept as historical record, not living docs).
...
> **Away Mode pivot descoped (2026-07-06):** The "Away Mode" product/pricing pivot and paid-workflow
> framing are retired (owner decision — never validated against real customers). Primary Away Mode
> strategy docs are archived under `docs/_archive/away-mode-2026-07/`. Wireframes and tables below
> may still use legacy "Away …" feature labels; the underlying capabilities (home ledger, launch
> composer, proof suite) remain in scope — only the Away Mode *brand/pivot* is gone.
...
existing one. Disposition of everything it supersedes or references:

| Doc | Disposition |
|---|---|
| **This doc** | ✅ Canonical, living. Update here going forward. |
| `docs/design-audit/lancer-workflows-2026-07-05/MASTER-REPORT.md` | Kept, referenced. This is the canonical **wireframe/audit process record** (what was built, what the 4-pass audit found, what Cursor fixed) — this plan cites it rather than duplicating it. Not superseded. |
| `docs/design-audit/2026-07-05-feature-checklist-for-wireframing.md` | Kept, referenced. The 105-item wireframe-tracking checklist — this plan's feature table is the decision layer on top of it, not a replacement. Not superseded. |
| `docs/design-audit/2026-07-05-final-cursor-wireframe-handoff.md` | Kept — canonical IA/handoff doc, already updated 2026-07-05 with post-Cursor status. Not superseded. |
| `docs/design-audit/lancer-workflows-2026-07-05/audit-findings/*.md` (4 files) | Kept, referenced. Raw audit findings; this plan resolves the open ones (§4). |
| `docs/design-audit/workflows/01-06-*.md` (6 files) | Kept — per-surface approved design specs. This plan's IA/discrepancy resolutions (§4) should be folded into these on the next wireframe touch-up pass (Phase 2 or a small follow-up). |
| `docs/product/2026-07-04-lancer-strategy-feature-source-of-truth.md` | **Superseded by this doc.** Was itself the best "read first" synthesis of the July-4 work — that role now belongs here. |
| `docs/_archive/away-mode-2026-07/` (4 Away Mode strategy docs) | **Archived + descoped** 2026-07-06 — see README in that folder. |
| `docs/product/2026-07-04-lancer-whole-app-consolidation.md` | **Superseded by this doc.** Whole-app-areas content folded into §7. |
| `docs/product/2026-07-04-lancer-mobile-primary-pivot-feature-inventory.md` | **Superseded by this doc.** Was explicitly scoped as "inspiration-gathering, not V1 commitment" — its accepted pieces are folded in; its non-goal-conflicting pieces are formally rejected in §8. |
| `docs/product/2026-07-04-codex-verification-brief.md` | **Superseded by this doc** (its checklist items are resolved in §7's correctness-gap table). |
| `docs/product/2026-07-04-codex-verification-results.md` | **Superseded by this doc** (its confirmed facts are folded into §7). |
| `docs/product/2026-07-05-mobile-native-ai-coding-workflow-research.md` | Kept, referenced — source material for the proof-to-ship pivot (§3). Not superseded; it's primary research, not a decision doc. |
| `docs/product/2026-07-05-lancer-proof-to-ship-visual-board/index.html` | Kept as reference artifact only. Its IA proposal (Needs-Me Queue home) is **not adopted** — see §3. |
| `docs/design-audit/2026-07-05-ios27-wwdc26-platform-capabilities.md` | Kept, updated in this pass (minor additive fixes) — remains the iOS 27/WWDC reference. Not superseded. |
...
- **Workflow 02's "four roots" language is a documentation error** — align it to the 3-root IA in
  the next wireframe touch-up. The real shipped code (`LancerSidebarView.swift`) already has 2 nav
  rows (Home, Machines) + New Chat CTA + gear-icon Settings, which is *closer* to this 3-root model
  than the stale 5-destination description in `ARCHITECTURE.md` §4.1 (already flagged for
  correction).
...
| Developer App Drawer | **Conflicts with the locked 3-root sidebar IA** (§2). |
